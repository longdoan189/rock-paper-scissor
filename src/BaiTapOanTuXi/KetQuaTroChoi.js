    ...
    render() {
        return (
            <div>
                ...
                <div className="display-4 text-warning">Game won: 
                    <span className="display-4 text-warning">{this.props.soBanThang}</span>
                </div>
                <div className="display-4 text-warning">Played: 
